...
ec.code = {
	...
	addShare : function(options){
		options = $.extend({
			//type : "tools",
			//lazy : true,
			jsUrl : "https://bdimg.share.baidu.com/static/api/js/share.js?v=86835285.js?cdnversion="+~(-new Date()/36e5)
		} , options);
	...
	addAnalytics:function(options){
		...
		if(options.baidu)ec.load({url:"https://hm.baidu.com/h.js?a08b68724dd89d23017170634e85acd8",type:"js",loadType:"lazy"});
		if(options.cnzz)ec.load({url : "https://s95.cnzz.com/stat.php?id=4754392&web_id=4754392",type:"js",loadType:"lazy"});
